  ...
  <div class="min-h-screen bg-white">
   ...
   />
    ...
    <div class="flex min-h-screen">
      ...
      <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#034080] to-[#0056b3] relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center px-12 xl:px-16 text-white">
          <div class="mb-8">
            ...
            <p class="text-xl text-white/90 leading-relaxed">
              Secure, passwordless authentication for a seamless experience. Join thousands of users who trust our platform.
            </p>
          </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-white/80">Advanced security with passwordless authentication</p>
              </div>
            </div>
            <div class="flex items-center gap-4">
              <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p class="text-white/80">Quick access without remembering passwords</p>
              </div>
            </div>
            <div class="flex items-center gap-4">
              <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p class="text-white/80">Join our community of verified users</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Decorative Elements -->
        <div class="absolute top-20 right-20 w-32 h-32 bg-[#e09a2a]/20 rounded-full blur-2xl"></div>
        ...
        <div class="w-full max-w-md">
          ...
          <div v-show="!showEmailLinkModal && !showOtpModal" class="bg-white border border-gray-100 rounded p-8">
            <form @submit.prevent="handleEmailLogin" class="space-y-6">
              <!-- Email Input -->
              <div class="space-y-2">
                <label for="email" class="block text-sm font-semibold text-[#034080]">
                  Email Address
                </label>
                <div class="relative">
                  <input
    ...
    <div>
      ...
      <p class="text-red-700 text-sm">{{ errorMessage }}</p>
            ...
            <button
              ...
              :disabled="isLoading"
              class="w-full bg-white border-2 border-gray-200 hover:border-[#e09a2a] hover:bg-gray-50 text-gray-700 font-semibold py-4 px-6 rounded transition-all duration-300 flex items-center justify-center gap-3 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      >
        ...
        <div class="p-6 overflow-y-auto max-h-[60vh]">
          <div class="prose prose-sm text-gray-700 space-y-6">
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">1. Acceptance of Terms</h3>
              <p class="leading-relaxed">By accessing and using our platform, you accept and agree to be bound by the terms and provision of this agreement.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">2. User Responsibilities</h3>
              <p class="leading-relaxed">Users are responsible for maintaining the confidentiality of their account information and for all activities that occur under their account.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">3. Seller Verification</h3>
              <p class="leading-relaxed">Seller registration requires verification and approval. Only legitimate business entities are permitted to register as sellers.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">4. Data Protection</h3>
              <p class="leading-relaxed">We are committed to protecting your personal information and will handle your data in accordance with our Privacy Policy.</p>
            </div>
          </div>
        </div>
    ...
    >
      ...
      >
        ...
        <div class="p-6 overflow-y-auto max-h-[60vh]">
          <div class="prose prose-sm text-gray-700 space-y-6">
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">Information We Collect</h3>
              <p class="leading-relaxed">We collect information you provide directly to us, such as when you create an account, make a purchase, or contact us for support.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">How We Use Your Information</h3>
              <p class="leading-relaxed">We use the information we collect to provide, maintain, and improve our services, process transactions, and communicate with you.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">Information Sharing</h3>
              <p class="leading-relaxed">We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as described in this policy.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-bold text-[#034080] mb-3">Data Security</h3>
              <p class="leading-relaxed">We implement appropriate security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.</p>
            </div>
          </div>
        </div>
        <div class="p-6 border-t border-gray-100 flex justify-end bg-gray-50">
